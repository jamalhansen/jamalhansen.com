...
**You can do real analytics.** [Window functions](https://jamalhansen.com/blog/window-functions-the-feature-python-developers-miss-most/) give you running totals, rankings, and row-to-row comparisons without collapsing your data. [CASE statements, date functions, and string functions](https://jamalhansen.com/blog/advanced-sql-topics-sampler/) let you categorize, slice by time period, and clean data on the fly.
